...
class ChattingRepository {
  final List<ChatDetail> chats = [
    ...
    ChatDetail(
        ...
        updateChat: '''Sure, here's one: Why don't scientists trust atoms? Because they make up everything!'''
    ),
    ChatDetail(
        roomId: 4,
        names: ['Olivia'],
        ...
        updateChat: '''Photosynthesis is the process by which plants convert light energy into chemical energy to fuel their growth.'''
    ),
    ChatDetail(
        roomId: 5,
        names: ['Ethan','Ava','Liam','Sophia'],
        talkerImage: ['assets/profile/Ethan.png','assets/profile/Ava.png','assets/profile/Liam.png','assets/profile/Sophia.png'],
    ...
    ChatDetail(
        ...
        updateChat: '''If you enjoy science fiction, I recommend "Dune" by Frank Herbert.'''
    ),
    ChatDetail(
        roomId: 7,
        names: ['Isabella'],
        ...
        updateChat: '''To reset your password, go to the login page and click on the "Forgot Password" link.'''
    ),
    ChatDetail(
        roomId: 8,
        names: ['Aiden', 'Harper'],
        ...
        updateChat: '''The meaning of life is a subjective question. Different people find meaning in different things.'''
    ),
    ChatDetail(
        roomId: 9,
        names: ['Lucas'],
    ...
    ChatDetail(
        ...
        talkerImage: ['assets/profile/Amelia.png', 'assets/profile/Benjamin.png'],
        updateDate: '2023-02-15 10:23',
        updateChat: '''I don't have a favorite color. I'm here to help you with information!'''
    ),
  ];
}
